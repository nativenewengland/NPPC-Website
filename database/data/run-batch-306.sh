#!/usr/bin/env bash
# Batch 306: Six verified civil-rights detainees; accumulate toward 100-person PR.
# After merging, pull main and apply earlier pending batches in order.
# sudo -u www-data bash database/data/run-batch-306.sh --dry-run
# sudo -u www-data bash database/data/run-batch-306.sh
...
if [[ $# -eq 1 && "$1" == "--dry-run" ]]; then
    ...
    echo "Usage: bash database/data/run-batch-306.sh [--dry-run]" >&2
    exit 2
fi
...
$payload = json_decode(File::get(base_path("database/data/fixes/batch306.json")), true, 512, JSON_THROW_ON_ERROR);
if (($payload["batch"] ?? null) !== 306 || ($payload["expected_count"] ?? null) !== 6 || count($payload["entries"] ?? []) !== 6) {
...
foreach ($payload["entries"] as $entry) {
    ...
    $expected = ["john-broxton" => ["name" => "John Broxton", "first_name" => "John", "middle_name" => null, "last_name" => "Broxton", "aka" => null, "description" => "John Broxton participated in the 1960 Tallahassee campaign against segregated lunch counters and the ensuing jail-in.", "affiliation" => ["Congress of Racial Equality", "Civil rights movement"], "state" => "Florida", "era" => "1960s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "william-larkins" => ["name" => "William Larkins", "first_name" => "William", "middle_name" => null, "last_name" => "Larkins", "aka" => null, "description" => "William Larkins participated in the 1960 Tallahassee campaign against segregated lunch counters and the ensuing jail-in.", "affiliation" => ["Congress of Racial Equality", "Civil rights movement"], "state" => "Florida", "era" => "1960s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "clement-carney" => ["name" => "Clement Carney", "first_name" => "Clement", "middle_name" => null, "last_name" => "Carney", "aka" => null, "description" => "Clement Carney participated in the 1960 Tallahassee campaign against segregated lunch counters and the ensuing jail-in.", "affiliation" => ["Congress of Racial Equality", "Civil rights movement"], "state" => "Florida", "era" => "1960s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "angela-nance" => ["name" => "Angela Nance", "first_name" => "Angela", "middle_name" => null, "last_name" => "Nance", "aka" => null, "description" => "Angela Nance participated in the 1960 Tallahassee campaign against segregated lunch counters and the ensuing jail-in.", "affiliation" => ["Congress of Racial Equality", "Civil rights movement"], "state" => "Florida", "era" => "1960s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "henry-marion-steele" => ["name" => "Henry Marion Steele", "first_name" => "Henry", "middle_name" => "Marion", "last_name" => "Steele", "aka" => "Henry Steele", "description" => "Henry Marion Steele participated in the 1960 Tallahassee campaign against segregated lunch counters and the ensuing jail-in.", "affiliation" => ["Congress of Racial Equality", "Civil rights movement"], "state" => "Florida", "era" => "1960s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "floyd-gardner" => ["name" => "Floyd Gardner", "first_name" => "Floyd", "middle_name" => null, "last_name" => "Gardner", "aka" => null, "description" => "Floyd Gardner was an Iowa student active in protests against racial discrimination. He joined the 1962 Albany, Georgia demonstrations and was held in the city jail awaiting trial.", "affiliation" => ["Civil rights movement", "Albany Movement"], "state" => "Georgia", "era" => "1960s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null]];
    ...
    $reviewed = ["john-broxton" => [], "william-larkins" => [], "clement-carney" => [], "angela-nance" => [], "henry-marion-steele" => [], "floyd-gardner" => []];
    if ($entry["dates"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed dates."); }
    $reviewed = ["john-broxton" => [["sentenced_date" => ["year" => 1960, "month" => 3, "day" => 17], "incarceration_date" => ["year" => 1960, "month" => 3]]], "william-larkins" => [["sentenced_date" => ["year" => 1960, "month" => 3, "day" => 17], "incarceration_date" => ["year" => 1960, "month" => 3]]], "clement-carney" => [["sentenced_date" => ["year" => 1960, "month" => 3, "day" => 17], "incarceration_date" => ["year" => 1960, "month" => 3]]], "angela-nance" => [["sentenced_date" => ["year" => 1960, "month" => 3, "day" => 17], "incarceration_date" => ["year" => 1960, "month" => 3]]], "henry-marion-steele" => [["sentenced_date" => ["year" => 1960, "month" => 3, "day" => 17], "incarceration_date" => ["year" => 1960, "month" => 3]]], "floyd-gardner" => [["arrest_date" => ["year" => 1962, "month" => 7, "day" => 21], "incarceration_date" => ["year" => 1962, "month" => 7, "day" => 21]]]];
    if ($entry["case_dates"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed case_dates."); }
    $reviewed = ["john-broxton" => ["John Broxton"], "william-larkins" => ["William Larkins"], "clement-carney" => ["Clement Carney"], "angela-nance" => ["Angela Nance"], "henry-marion-steele" => ["Henry Marion Steele", "Henry Steele"], "floyd-gardner" => ["Floyd Gardner"]];
    if ($entry["match_names"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed match_names."); }
    $reviewedCases = ["john-broxton" => [["charges" => "Inciting to riot — Tallahassee lunch-counter sit-in", "sentence" => "Sixty days or a $300 fine at the March 17, 1960 trial. Chose jail; correspondence confirms continued confinement at Leon County Jail on April 28. Exact release remains unverified."]], "william-larkins" => [["charges" => "Inciting to riot — Tallahassee lunch-counter sit-in", "sentence" => "Sixty days or a $300 fine at the March 17, 1960 trial. Chose jail; correspondence confirms continued confinement at Leon County Jail on April 28. Exact release remains unverified."]], "clement-carney" => [["charges" => "Inciting to riot — Tallahassee lunch-counter sit-in", "sentence" => "Sixty days or a $300 fine at the March 17, 1960 trial. Chose jail; correspondence confirms continued confinement at Leon County Jail on April 28. Exact release remains unverified."]], "angela-nance" => [["charges" => "Inciting to riot — Tallahassee lunch-counter sit-in", "sentence" => "Sixty days or a $300 fine at the March 17, 1960 trial. Chose jail; correspondence confirms continued confinement at Leon County Jail on April 28. Exact release remains unverified."]], "henry-marion-steele" => [["charges" => "Inciting to riot — Tallahassee lunch-counter sit-in", "sentence" => "Sixty days or a $300 fine at the March 17, 1960 trial. Chose jail; correspondence confirms continued confinement at Leon County Jail on April 28. Exact release remains unverified."]], "floyd-gardner" => [["charges" => "Parading without a permit; violating traffic signals; obstructing traffic; congregating on sidewalks", "sentence" => "Held awaiting trial from July 21, 1962; still in Albany city jail in August 8-9 reporting. Individual sentence and exact release remain unverified."]]];
...
echo "B306-OK\n";
'
run "add-affiliation-prisoners" "B306-OK" "$ADD_CODE" || exit 1
echo "Batch 306 complete (dry run: ${NPPC_BATCH_DRY_RUN})."
