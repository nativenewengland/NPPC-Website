#!/usr/bin/env bash
# Batch 290: Four missing Lancaster protesters with actual pretrial custody.
...
if [[ $# -eq 1 && "$1" == "--dry-run" ]]; then
    ...
    echo "Usage: bash database/data/run-batch-290.sh [--dry-run]" >&2
    exit 2
fi
...
$payload = json_decode(File::get(base_path("database/data/fixes/batch290.json")), true, 512, JSON_THROW_ON_ERROR);
if (($payload["batch"] ?? null) !== 290 || ($payload["expected_count"] ?? null) !== 4 || count($payload["entries"] ?? []) !== 4) {
...
foreach ($payload["entries"] as $entry) {
    ...
    $expected = ["alexa-wise" => ["name" => "Alexa Wise", "affiliation" => ["Black Lives Matter Movement"], "state" => "Pennsylvania", "era" => "2020s", "lat" => 40.04, "lng" => -76.31, "in_custody" => false, "released" => true, "website" => null, "gender" => "Female", "race" => null, "inmate_number" => null], "dylan-davis-lancaster" => ["name" => "Dylan Davis", "affiliation" => ["Black Lives Matter Movement"], "state" => "Pennsylvania", "era" => "2020s", "lat" => 40.04, "lng" => -76.31, "in_custody" => false, "released" => true, "website" => null, "gender" => "Male", "race" => null, "inmate_number" => null], "barry-jones-iii-lancaster" => ["name" => "Barry Jones III", "affiliation" => ["Black Lives Matter Movement"], "state" => "Pennsylvania", "era" => "2020s", "lat" => 40.04, "lng" => -76.31, "in_custody" => false, "released" => true, "website" => null, "gender" => "Male", "race" => null, "inmate_number" => null], "t-jay-fry" => ["name" => "T-Jay Fry", "affiliation" => ["Black Lives Matter Movement"], "state" => "Pennsylvania", "era" => "2020s", "lat" => 40.04, "lng" => -76.31, "in_custody" => false, "released" => false, "website" => null, "gender" => "Male", "race" => null, "inmate_number" => null]];
    ...
    $reviewedDates = ["alexa-wise" => [["arrest_date" => ["year" => 2020, "month" => 9, "day" => 14], "sentenced_date" => ["year" => 2023, "month" => 4, "day" => 4], "incarceration_date" => ["year" => 2020, "month" => 9, "day" => 14], "release_date" => ["year" => 2020, "month" => 9, "day" => 17]]], "dylan-davis-lancaster" => [["arrest_date" => ["year" => 2020, "month" => 9, "day" => 14], "sentenced_date" => ["year" => 2023, "month" => 2, "day" => 3], "incarceration_date" => ["year" => 2020, "month" => 9, "day" => 14], "release_date" => ["year" => 2020, "month" => 9, "day" => 17]]], "barry-jones-iii-lancaster" => [["arrest_date" => ["year" => 2020, "month" => 9, "day" => 14], "sentenced_date" => ["year" => 2022, "month" => 7, "day" => 19], "incarceration_date" => ["year" => 2020, "month" => 9, "day" => 14], "release_date" => ["year" => 2020, "month" => 9, "day" => 17]]], "t-jay-fry" => [["arrest_date" => ["year" => 2020, "month" => 9, "day" => 14], "sentenced_date" => ["year" => 2022, "month" => 9, "day" => 8]]]];
    $reviewedVitals = ["alexa-wise" => [], "dylan-davis-lancaster" => [], "barry-jones-iii-lancaster" => [], "t-jay-fry" => []];
    $reviewedCases = ["alexa-wise" => [["charges" => "Riot; failure to disperse; obstruction of highways; disorderly conduct; defiant trespass", "convicted" => "Jury conviction January 19, 2023; acquitted of conspiracy to commit riot", "sentence" => "Three years of probation and 125 hours of community service, imposed April 4, 2023. Only the documented September 2020 jail interval is counted as imprisonment; subsequent house arrest and probation are excluded."]], "dylan-davis-lancaster" => [["charges" => "Riot; criminal conspiracy; failure to disperse; obstruction of highways; disorderly conduct; dangerous burning", "convicted" => "Bench-trial conviction November 7, 2022", "sentence" => "Three years of probation imposed February 3, 2023. The recorded jail interval ends at release on September 17, 2020; house arrest and probation are not added to the imprisonment counter."]], "barry-jones-iii-lancaster" => [["charges" => "Failure to disperse", "convicted" => "Convicted of failure to disperse; sentenced July 19, 2022", "sentence" => "Time served to twelve months, plus 25 hours of community service, imposed July 19, 2022. The individually verified physical jail interval is September 14–17, 2020. No additional post-sentence jail stay or maximum term served is inferred."]], "t-jay-fry" => [["charges" => "Failure to disperse; defiant trespass", "convicted" => "Guilty plea September 8, 2022", "sentence" => "Fines and court costs ordered September 8, 2022. This record concerns verified multi-day pretrial jail custody, not a custodial sentence. No precise release date, total days served or continuing imprisonment is asserted."]]];
    ...
    $approvedPhotos = ["alexa-wise" => ["source_file" => "database/data/photos/alexa-wise-lancaster-da.jpg", "storage_path" => "prisoners/alexa-wise-lancaster-da.jpg", "sha256" => "d62c6ad7e1b6955b4a778d2781ae2b1480534a3a4a946eddb62637f533101d02", "source_id" => "verdict"], "dylan-davis-lancaster" => null, "barry-jones-iii-lancaster" => null, "t-jay-fry" => null];
...
echo "B290-OK\n";
'
run "add-affiliation-prisoners" "B290-OK" "$ADD_CODE" || exit 1
echo "Batch 290 complete (dry run: ${NPPC_BATCH_DRY_RUN})."
