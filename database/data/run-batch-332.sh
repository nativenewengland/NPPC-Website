#!/usr/bin/env bash
# Batch 332: Five verified historical US detainees; accumulate toward 100-person PR.
# After merging, pull main and apply earlier pending batches in order.
# sudo -u www-data bash database/data/run-batch-332.sh --dry-run
# sudo -u www-data bash database/data/run-batch-332.sh
...
if [[ $# -eq 1 && "$1" == "--dry-run" ]]; then
    ...
    echo "Usage: bash database/data/run-batch-332.sh [--dry-run]" >&2
    exit 2
fi
...
$payload = json_decode(File::get(base_path("database/data/fixes/batch332.json")), true, 512, JSON_THROW_ON_ERROR);
if (($payload["batch"] ?? null) !== 332 || ($payload["expected_count"] ?? null) !== 5 || count($payload["entries"] ?? []) !== 5) {
...
if ($precisionProbe->computeImprisonedForDays() !== null) { throw new \RuntimeException("Pull the accompanying partial-date counter fix before applying batch 332."); }
...
foreach ($payload["entries"] as $entry) {
    ...
    $expected = ["michael-martin" => ["name" => "Michael Martin", "first_name" => "Michael", "middle_name" => null, "last_name" => "Martin", "aka" => "Mixey Martin; Mixie Martin; Michael Mixey Martin; Michael Mixie Martin", "description" => "Michael Martin, known as Mixey or Mixie, was an Irish republican from County Down imprisoned in the United States in the Tucson arms case. His US custody ended with transfer to a prison in Ireland.", "affiliation" => ["Irish Republican Army"], "state" => "Arizona", "era" => "1990s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "denis-leyne" => ["name" => "Denis Leyne", "first_name" => "Denis", "middle_name" => null, "last_name" => "Leyne", "aka" => null, "description" => "Denis Leyne was one of the Tucson Six, defendants prosecuted over alleged arms supplies to the IRA. He was held in US federal custody before the six were acquitted in April 1994.", "affiliation" => ["Tucson Six"], "state" => "New York", "era" => "1990s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "thomas-oliver-maguire" => ["name" => "Thomas Oliver Maguire", "first_name" => "Thomas", "middle_name" => "Oliver", "last_name" => "Maguire", "aka" => "Thomas Maguire", "description" => "Thomas Oliver Maguire was one of the Tucson Six, defendants prosecuted over alleged arms supplies to the IRA. He was held in US federal custody before the six were acquitted in April 1994.", "affiliation" => ["Tucson Six"], "state" => "New York", "era" => "1990s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "gerard-anthony-brannigan" => ["name" => "Gerard Anthony Brannigan", "first_name" => "Gerard", "middle_name" => "Anthony", "last_name" => "Brannigan", "aka" => "Gerard Brannigan; Tony Brannigan", "description" => "Gerard Anthony Brannigan was one of the Tucson Six, defendants prosecuted over alleged arms supplies to the IRA. He was held in US federal custody before the six were acquitted in April 1994.", "affiliation" => ["Tucson Six"], "state" => "New York", "era" => "1990s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null], "patrick-moley" => ["name" => "Patrick Moley", "first_name" => "Patrick", "middle_name" => null, "last_name" => "Moley", "aka" => null, "description" => "Patrick Moley was one of the Tucson Six, defendants prosecuted over alleged arms supplies to the IRA. He was held in US federal custody before the six were acquitted in April 1994.", "affiliation" => ["Tucson Six"], "state" => "New York", "era" => "1990s", "lat" => null, "lng" => null, "in_custody" => false, "released" => true, "website" => null, "gender" => null, "race" => null, "inmate_number" => null]];
    ...
    $reviewed = ["michael-martin" => [], "denis-leyne" => [], "thomas-oliver-maguire" => [], "gerard-anthony-brannigan" => [], "patrick-moley" => []];
    if ($entry["dates"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed dates."); }
    $reviewed = ["michael-martin" => [["incarceration_date" => ["year" => 1995, "month" => 9], "release_date" => ["year" => 1996, "month" => 1, "day" => 31]], ["incarceration_date" => ["year" => 1994, "month" => 12], "sentenced_date" => ["year" => 1995, "month" => 6], "release_date" => ["year" => 1995]]], "denis-leyne" => [["arrest_date" => ["year" => 1992, "month" => 11, "day" => 11], "incarceration_date" => ["year" => 1992, "month" => 11, "day" => 11]]], "thomas-oliver-maguire" => [["arrest_date" => ["year" => 1992, "month" => 11, "day" => 11], "incarceration_date" => ["year" => 1992, "month" => 11, "day" => 11]]], "gerard-anthony-brannigan" => [["arrest_date" => ["year" => 1992, "month" => 11, "day" => 11], "incarceration_date" => ["year" => 1992, "month" => 11, "day" => 11]]], "patrick-moley" => [["arrest_date" => ["year" => 1992, "month" => 11, "day" => 11], "incarceration_date" => ["year" => 1992, "month" => 11, "day" => 11]]]];
    if ($entry["case_dates"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed case_dates."); }
    $reviewed = ["michael-martin" => ["Michael Martin", "Mixey Martin", "Mixie Martin", "Michael Mixey Martin", "Michael Mixie Martin"], "denis-leyne" => ["Denis Leyne"], "thomas-oliver-maguire" => ["Thomas Oliver Maguire", "Thomas Maguire"], "gerard-anthony-brannigan" => ["Gerard Anthony Brannigan", "Gerard Brannigan", "Tony Brannigan"], "patrick-moley" => ["Patrick Moley"]];
    if ($entry["match_names"] !== $reviewed[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed match_names."); }
    $reviewedCases = ["michael-martin" => [["charges" => "Conspiracy to buy a Stinger missile for the IRA; recommittal following mistaken early release", "sentence" => "Returned to US custody in September 1995. Transferred to Portlaoise Prison on January 31, 1996; this endpoint records the end of US custody, not freedom. His later February 18 release in Ireland is excluded from US time served."], ["charges" => "Conspiracy to buy a Stinger missile for the IRA", "sentence" => "Extradited from London in December 1994; sentenced in June 1995 to sixteen months after a guilty plea. Mistakenly released during 1995 before September recommittal. The imposed sentence is not entered as actual months served."]], "denis-leyne" => [["charges" => "Alleged conspiracy to supply arms to the IRA; acquitted", "sentence" => "Pretrial detention at Otisville continued after bail was granted on November 17, 1992. Acquitted in April 1994; no sentence imposed in this prosecution. The actual bail-release date is unresolved."]], "thomas-oliver-maguire" => [["charges" => "Alleged conspiracy to supply arms to the IRA; acquitted", "sentence" => "Pretrial detention at Otisville continued after bail was granted on November 17, 1992. Acquitted in April 1994; no sentence imposed in this prosecution. The actual bail-release date is unresolved."]], "gerard-anthony-brannigan" => [["charges" => "Alleged conspiracy to supply arms to the IRA; acquitted", "sentence" => "Pretrial detention at Otisville continued after bail was granted on November 17, 1992. Acquitted in April 1994; no sentence imposed in this prosecution. The actual bail-release date is unresolved."]], "patrick-moley" => [["charges" => "Alleged conspiracy to supply arms to the IRA; acquitted", "sentence" => "Pretrial detention at Otisville continued after bail was granted on November 17, 1992. Acquitted in April 1994; no sentence imposed in this prosecution. The actual bail-release date is unresolved."]]];
    if ($entry["prisoner"]["cases"] !== $reviewedCases[$entry["key"]]) { throw new \RuntimeException("Unexpected reviewed cases."); }
    if (isset($entry["photo"])) { throw new \RuntimeException("No portrait was verified for batch332."); }
...
echo "B332-OK\n";
'
run "add-affiliation-prisoners" "B332-OK" "$ADD_CODE" || exit 1
echo "Batch 332 complete (dry run: ${NPPC_BATCH_DRY_RUN})."
