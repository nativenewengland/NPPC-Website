# Outstanding prisoner photos

People requested for a portrait whose source could **not** be retrieved
automatically — almost always because the linked page renders its image with
JavaScript, sits behind a paywall/stock watermark, or resolved to a
non-portrait image (logo, group scene, illustration). Everything here still
needs either a **direct image URL** (right-click the photo → *Copy Image
Address*) or a rights determination.

Photos that *were* added this session live in `nonfree/` and are attached by
the `prisoners:attach-*` commands; see `CREDITS-nonfree.md` for provenance.

## Needs a direct image URL
...
| Ralph DiGia | War Resisters League | only the site logo was exposed |
| James Omura | Calisphere | JS viewer |
| Kiyoshi Okamoto | Densho (with George Nozawa) | JS |
| Isamu "Sam" Horino | Densho | JS |
| Frank Emi | Densho | JS |
...
| Mary Crow Dog / Mary Brave Bird | ICT archive | no extractable image |
| Mohaman Koti / James Johnson | Jericho Movement (& letsgetfree) | JS / origin 404 |
| George Wright / José Luís Jorge dos Santos | FBI Wanted | JS |
| Johnny Spain | FoundSF | JS wiki |
...
| Mary Trotochaud | Catholic News Archive | JS |
| Keith LaMar / Bomani Shakur | keithlamar.org | JS |
| Siddique Abdullah Hasan | PBS NewsHour (Getty) | resolved to a prison-yard scene |
| Sundiata Jawanza | Givebutter | resolved to an illustration |
| Rik Scarce | Skidmore | JS |
| Max Obuszewski | Democracy Now | JS |
| Steve Hindi | SHARK | JS |
| Lori Berenson | Democracy Now / Reuters | Reuters paywalled; DN JS |
| Wen Ho Lee | Federal Bar (Chicago) | group photo; extraction failed |
| Sam Day Jr. | WRMEA | JS |
